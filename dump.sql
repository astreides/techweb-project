...
INSERT INTO `products` (`name`,`description`,`range_id`,`unit_price`,`cutiness`,`lien_image`) VALUES ('Loutre','Le bébé loutre est un bébé tout tout mignon, voulez vous le commandez?',4,48.12,288,'images/Loutre.PNG');
